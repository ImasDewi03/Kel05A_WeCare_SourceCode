...
if (isset($_POST['submit'])) {
	...
	$sql = "INSERT INTO `medical_checkup` (`id_owner`, `nama_anda`, `nama_hewanpeliharaan`, `email`, `jenis_hewanpeliharaan`, `ras_hewanpeliharaan`, `keterangan`) VALUES ('', '$nama_anda', '$nama_hewanpeliharaan', '$email', '$jenis_hewanpeliharaan', '$ras_hewanpeliharaan', '$keterangan')";
